...
dotnet run --project ./Airport_Check_In/WebApplication_CheckIn/WebApplication_CheckIn.csproj 2>&1 | tee logs/9.txt1 &
dotnet run --project ./Airport_tablo/WebApiAirportNew/WebApiAirportNew.csproj 2>&1 | tee logs/15.txt &
